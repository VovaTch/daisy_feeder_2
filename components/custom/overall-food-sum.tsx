  ...
  return (
    <div className="items-center justify-center flex flex-col ">
      ...
      <div className="flex flex-1 items-center justify-between">
        <h2
          className="lg:px-20 lg:mx-10 py-3 px-5 mx-5 bg-slate-100 bg-[url('/images/dry-food.jpg')] bg-blend-overlay bg-cover
        ...
        <h2
          className="lg:px-20 lg:mx-10 py-3 px-5 mx-5 bg-slate-100 bg-[url('/images/wet-food.jpg')] bg-blend-overlay bg-cover

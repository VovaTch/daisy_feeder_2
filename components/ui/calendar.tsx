  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-orange-500 text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "bg-amber-300 text-accent-foreground",
        day_outside:
